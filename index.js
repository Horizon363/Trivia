...
function showQuestion(data){
    ...
    _question.innerHTML = `${data.question} <br> <span class = "Categoria"> ${data.category} </span>`;
    _options.innerHTML = `
...
function checkAnswer(){
    ...
    if(_options.querySelector('.selected')){
        ...
        if(selectedAnswer == HTMLDecode(correctAnswer)){
            ...
            _result.innerHTML = `<p><i class = "fas fa-times"></i>Respuesta Incorrecta!</p> <small><b>La respuesta correcta es: </b>${correctAnswer}</small>`;
        }
        checkCount();
    } else {
